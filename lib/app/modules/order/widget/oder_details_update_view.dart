...
import 'package:citgroupvn_efood_table/app/modules/cart/cart_screen_update.dart';
import 'package:citgroupvn_efood_table/app/modules/order/payment.dart';

class OrderDetailsUpdateView extends StatefulWidget {
  final String? idOder;
  const OrderDetailsUpdateView({Key? key, this.idOder}) : super(key: key);

  @override
  State<OrderDetailsUpdateView> createState() => _OrderDetailsUpdateViewState();
}

class _OrderDetailsUpdateViewState extends State<OrderDetailsUpdateView> {
  void intitState() {
    Get.find<OrderController>().getCurrentOrder(widget.idOder);
    super.initState();
  }
