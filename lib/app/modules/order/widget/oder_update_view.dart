...
import 'package:citgroupvn_efood_table/app/modules/order/widget/oder_details_update_view.dart';
import 'order_details_view.dart';

class OrdersUpdateScreen extends StatefulWidget {
  final bool isOrderDetails;
  const OrdersUpdateScreen({Key? key, this.isOrderDetails = false})
      : super(key: key);

  @override
  State<OrdersUpdateScreen> createState() => _OrdersUpdateScreenState();
}

class _OrdersUpdateScreenState extends State<OrdersUpdateScreen> {
  @override
  void initState() {
          ...
          : orderController.orderList!.isNotEmpty
              ? Column(
                  children: [
                    ...
                    const Flexible(child: OrderDetailsUpdateView()),
                  ],
                )
